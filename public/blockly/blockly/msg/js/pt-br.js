...
Blockly.Msg.READ_INTEGER = "ler %1 como um %2"
...
// Ardublockly strings
Blockly.Msg.ARD_ANALOGREAD = "ler pino analógico";  // untranslated
Blockly.Msg.ARD_ANALOGREAD_TIP = "Return value between 0 and 1024";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE = "definir pino analógico";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE_TIP = "Write analog value between 0 and 255 to a specific PWM Port";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED = "definir LED embutido para";  // untranslated
...
Blockly.Msg.ARD_DIGITALREAD = "ler pino digital";  // untranslated
Blockly.Msg.ARD_DIGITALREAD_TIP = "Read digital value on a pin: HIGH or LOW";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE = "definir pino digital";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE_TIP = "Write digital value HIGH or LOW to a specific Port";  // untranslated
Blockly.Msg.ARD_FUN_RUN_LOOP = "Loop:";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "Setup:";  // untranslated
Blockly.Msg.ARD_FUN_RUN_TIP = "Define as funções do arduino setup() e loop().";  // untranslated
...
Blockly.Msg.ARD_NOTONE = "desligar o tom no pino";  // untranslated
...
Blockly.Msg.ARD_PULSE_READ = "ler um pulso %1 no pino %2";  // untranslated
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "ler um pulso %1 no pino %2 (depois de %3 μs)";  // untranslated
...
Blockly.Msg.ARD_SERIAL_PRINT = "imprimir";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "com uma nova linha";  // untranslated
...
Blockly.Msg.ARD_SERIAL_SPEED = ":  velocidade para";  // untranslated
Blockly.Msg.ARD_SERVO_READ = "ler SERVO do pino";  // untranslated
Blockly.Msg.ARD_SERVO_READ_TIP = "Read a Servo angle";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE = "definir SERVO do pino";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "(0~180) graus";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TIP = "Set a Servo to an specified angle";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TO = "para";  // untranslated
Blockly.Msg.ARD_SETTONE = "definir o tom no pino";  // untranslated
Blockly.Msg.ARD_SPI_SETUP = "definir";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_CONF = "configuração:";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "clock divide";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "LSBFIRST";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE = "modo de SPI (ocioso - borda)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE0 = "0 (Baixo - Caindo)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE1 = "1 (Baixo - Subindo)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE2 = "2 (Alto - Caindo)";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE3 = "3 (Alto - Subindo)";  // untranslated
...
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "para pino escravo";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_TIP = "Send a SPI message to an specified slave device.";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_VAL = "transferir";  // untranslated
...
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "Número de pinos";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN1 = "pino 1";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN2 = "pino 2";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN3 = "pino 3";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN4 = "pino 4";  // untranslated
Blockly.Msg.ARD_STEPPER_REVOLVS = "quantidade passos por revolução";  // untranslated
...
Blockly.Msg.ARD_STEPPER_SPEED = "definir velocidade (rpm) para";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP = "mover stepper";  // untranslated
Blockly.Msg.ARD_STEPPER_STEPS = "passos";  // untranslated
...
Blockly.Msg.ARD_TIME_DELAY = "Espere";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICROS = "microssegundos";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Wait specific time in microssegundos";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_TIP = "Wait specific time in milliseconds";  // untranslated
Blockly.Msg.ARD_TIME_INF = "esperar para sempre (terminar programa)";  // untranslated
Blockly.Msg.ARD_TIME_INF_TIP = "Wait indefinitely, stopping the program.";  // untranslated
Blockly.Msg.ARD_TIME_MICROS = "tempo decorrido (microssegundos)";  // untranslated
...
Blockly.Msg.ARD_TIME_MILLIS = "tempo decorrido (milisegundos)";  // untranslated
...
Blockly.Msg.ARD_TIME_MS = "milisegundos";  // untranslated
Blockly.Msg.ARD_TONEFREQ = "com frequência";  // untranslated
Blockly.Msg.ARD_TONE_FREQ = "frequência";  // untranslated
...
Blockly.Msg.ARD_TYPE_BOOL = "Booleano";  // untranslated
Blockly.Msg.ARD_TYPE_CHAR = "Caracter";  // untranslated
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";  // untranslated
Blockly.Msg.ARD_TYPE_DECIMAL = "Decimal";  // untranslated
Blockly.Msg.ARD_TYPE_LONG = "Inteiro longo";  // untranslated
Blockly.Msg.ARD_TYPE_NULL = "Null";  // untranslated
Blockly.Msg.ARD_TYPE_NUMBER = "Inteiro";  // untranslated
Blockly.Msg.ARD_TYPE_SHORT = "Inteiro curto";  // untranslated
Blockly.Msg.ARD_TYPE_TEXT = "Texto";  // untranslated
Blockly.Msg.ARD_TYPE_UNDEF = "Indefinido";  // untranslated
Blockly.Msg.ARD_VAR_AS = "como";  // untranslated
Blockly.Msg.ARD_VAR_AS_TIP = "Sets a value to a specific type";  // untranslated
Blockly.Msg.ARD_WRITE_TO = "para";  // untranslated
