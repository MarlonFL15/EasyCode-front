...
Ardublockly.generateArduino = function() {
    var value = document.getElementById('code_language').value
    document.getElementById('code_question_send').innerHTML = Blockly['Python'].workspaceToCode(Ardublockly.workspace) 
  return Blockly[value].workspaceToCode(Ardublockly.workspace);
};
